#!/usr/bin/env python3
"""批量测试CFD数据集 - 仅2D分割版本（不依赖PyTorch3D）"""
import sys
...
def main():
    ...
    # 定义路径
    images_dir = Path(r"g:\Zed\testData\pavement crack datasets\CFD\cfd_image")
    output_dir = Path(r"g:\Zed\testData\pavement crack datasets\CFD\output")
